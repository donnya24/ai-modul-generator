          ...
          cleanedRows.forEach((row, index) => {
            ...
            if (index === 0) {
              ...
              cells.forEach((cell, cellIndex) => {
                ...
                const alignStyle =
                  isTPTable && cellIndex > 0 ? "center" : "left";
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Isi semua form dengan data yang sesuai, kemudian klik "Buat
                    Modul Ajar".
                  </p>
                </div>
                <div>
                  <p className="font-medium text-gray-700">
                    ❓ Apakah modul yang dihasilkan sesuai kurikulum?
                  </p>
                  <p className="text-sm text-gray-600 mt-1">
                    Ya, modul disusun sesuai Kurikulum Merdeka dan Kurikulum
                    Berbasis Cinta.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-gray-700">
                    ❓ Bisakah saya mengedit hasil modul?
                  </p>
                  <p className="text-sm text-gray-600 mt-1">
                    Ya, hasil bisa diedit langsung di Microsoft Word setelah
                    diunduh.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-teal-50 to-emerald-50 p-4 rounded-lg border border-teal-100">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Punya pertanyaan spesifik? Hubungi kami via WhatsApp untuk
                    konsultasi langsung.
                  </p>
                  <a
